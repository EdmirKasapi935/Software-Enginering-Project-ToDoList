...
public class AddTaskForm extends JFrame {
    ...
    private void buildMainPanel() {
        ...
        submitButton = AppDimensions.makeButton("Add Task", AppDimensions.BTN_PRIMARY,  AppDimensions.BTN_PRIMARY_FG);
    ...
    private void initializeDueDateSpinner() {
        SpinnerDateModel m = new SpinnerDateModel(todayWithoutTime(), todayWithoutTime(), null, Calendar.DAY_OF_MONTH);
